...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    protected function _applyMaxLenth($storeId, $seo, $page)
    {
        if ($metaTitleMaxLength = $this->config->getMetaTitleMaxLength($storeId)) {
            ...
            $seo->setMetaTitle($this->stringPrepare->getTruncatedString($seo->getMetaTitle(), $metaTitleMaxLength, $page));
        }
        ...
        if ($isProductPage && $productShortDescriptionMaxLength = $this->config->getProductShortDescriptionMaxLength($storeId)) {
