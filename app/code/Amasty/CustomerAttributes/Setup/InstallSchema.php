...
class InstallSchema implements InstallSchemaInterface
{
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()
            ...
            ->addForeignKey(
                $installer->getFkName('amasty_customer_attributes_details', 'relation_id', 'amasty_customer_attributes_relation', 'id'),
                'relation_id',
                $installer->getTable('amasty_customer_attributes_relation'),
                'id',
                \Magento\Framework\DB\Ddl\Table::ACTION_CASCADE
            )
            ->setComment('Amasty Customer Attributes Details');
