<?php
namespace Emizentech\CustomSmtp\Controller\Adminhtml\Check;
...
class Testmail extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Emizentech\CustomSmtp\Helper\Data $helper
    ) {
    ...
    public function execute() {
        ...
        $testMail->setSubject('Test SMTP Email from Emizen Tech Private Limited');
        $testMail->addTo($to, $to);
        $testMail->setBodyText('Thank you for choosing Emizen Tech\'s extension.');
